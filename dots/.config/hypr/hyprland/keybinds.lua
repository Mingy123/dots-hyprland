...
hl.bind("SUPER + P", hl.dsp.global("quickshell:searchToggle"), { description = "Shell: Toggle search" })
...
hl.bind("SUPER_R", hl.dsp.global("quickshell:workspaceNumber"),
    { ignore_mods = true, transparent = true, release = true })
hl.bind("SUPER + Tab", hl.dsp.focus({ workspace = "previous_per_monitor" }), { description = "Shell: Toggle overview" })
hl.bind("SUPER + V", hl.dsp.global("quickshell:overviewClipboardToggle"))
hl.bind("SUPER + SHIFT + Period", hl.dsp.global("quickshell:overviewEmojiToggle"))
hl.bind("SUPER + A", hl.dsp.global("quickshell:sidebarLeftToggle"), { description = "Shell: Toggle left sidebar" })
hl.bind("SUPER + ALT + A", hl.dsp.global("quickshell:sidebarLeftToggleDetach"))
hl.bind("SUPER + Z", hl.dsp.global("quickshell:sidebarRightToggle"), { description = "Shell: Toggle right sidebar" })
...
hl.bind("SUPER + SHIFT + Q", hl.dsp.global("quickshell:sessionToggle"), { description = "Shell: Toggle session menu" })
hl.bind("SUPER + SPACE", hl.dsp.global("quickshell:barToggle"), { description = "Shell: Toggle bar" })
...
hl.bind("SUPER + PERIOD", hl.dsp.focus({ workspace = "m+1" }))
hl.bind("SUPER + LEFT", hl.dsp.focus({ workspace = "-1" }))
hl.bind("SUPER + RIGHT", hl.dsp.focus({ workspace = "+1" }))
hl.bind("SUPER + DOWN", hl.dsp.focus({ workspace = "-2" }))
hl.bind("SUPER + UP", hl.dsp.focus({ workspace = "+2" }))
...
--##! Apps
hl.bind("SUPER + SHIFT + Return", hl.dsp.exec_cmd(terminal), { description = "App: Terminal" })
